...
data.r_1		= 2.077e-18*5*10^4/2.8415;       % [] 	Sum of products of rate constants ??? Can we replace this expression with it's result????
data.r_2		= 1.728e-9;		 	% []			Sum of products of rate constants 
data.r_3		= 1.059e-26;		% []			Sum of products of rate constants
data.rho_res	= 30/1.9; 		% [mM] 			Concentration of electron carriers (respiratory complexes I-III-IV) ??? Can we replace this expression with it's result????
...
data.rho_F1		= 1.5e-3;				% [mM] 			Concentration of F1F0-ATPASE
...
data.V_ant_max	= 1.449184114050679e-05;		% [mM/ms] 		Maximal rate of ANT
...
data.k_cat_cs	= 0.05*1.942993891029652;				% [1/ms] 		Catalytic constant of CS
...
data.k_f_ACO	= 1.25e-5*42.491734773872118; 			% 1/[ms]		Forward rate constant of ACO
data.k_E_ACO	= 0.9;   			% [] 			Equilibrium constant of ACO
...
y0(45)	= 8e-4;					% [aKG]			[mM]		Α-ketoglutarate concentration (mitochondrial)
...
y0(50)	= 2.367e-4;					% [OAA] 		[mM]		Oxaloacetate concentration (mitochondrial)
