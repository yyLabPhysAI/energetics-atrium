...
dO_c     = (200000.*Ca_i.*(1 - O_c) - 100.*O_c);
...
dO_Calse = (480*2.*Ca_rel.*(1 - O_Calse) - 400.*O_Calse)/1000;
phi_ca_i = 0.08.*dO_TnCa + 0.16.*dO_TnMgCa + 0.045.*dO_c;

dCa_up = (I_up - I_tr)./(2.*F.*V_up);
dCa_rel = (I_tr - I_rel)./(2.*F.*V_rel) - 21.*dO_Calse;
