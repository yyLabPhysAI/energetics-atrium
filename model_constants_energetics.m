...
data.rho_res	= 3e-3*10^5; 		% [mM] 			Concentration of electron carriers (respiratory complexes I-III-IV) ??? Can we replace this expression with it's result????
...
data.p_c1		= 9.651e-17*10^10;	% 1/[ms]		Sum of products of rate constants	??? Can we replace this expression with it's result????
data.p_c2		= 7.739e-17*10^10;	% 1/[ms]		Sum of products of rate constants	??? Can we replace this expression with it's result????
